...
public class RelationalExpr extends BinaryExpr {
    ...
    public void checkConstraints() {
        ...
        try{
            Expression lOperand = getLeftOperand();
            Expression rOperand = getRightOperand();
            
            lOperand.checkConstraints();
            rOperand.checkConstraints();
            ...
            if(lOperand.getType() != rOperand.getType()){
                ...
                if(lOperand.getType() != Type.Integer && lOperand.getType() != Type.Boolean && lOperand.getType() != Type.Char){
